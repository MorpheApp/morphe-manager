...
4. **Provide the APK** - Morphe guides you through obtaining the original app file via step-by-step dialogs. The patching itself happens entirely on your device (Remember to move the apk file to the root directory not in the Download folder after downloaded otherwise it wouldn't work).
